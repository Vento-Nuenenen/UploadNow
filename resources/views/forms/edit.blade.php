        ...
        <div class="card EditParticipant mb-3">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent=".EditParticipant">
                <div class="card-body table-responsive">
                    {!! Form::open(array('route' => ['update-forms',$forms->id], 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group has-feedback row {{ $errors->has('form_name') ? ' has-error ' : '' }}">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                {!! Form::text('form_name', old('form_name', $forms->form_name ?? null), array('id' => 'form_name', 'class' => 'form-control', 'placeholder' => 'Formularname', 'required')) !!}
                    ...
                    <div class="form-group has-feedback row {{ $errors->has('form_description') ? ' has-error ' : '' }}">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                {!! Form::textarea('form_description', old('form_description', $forms->form_description ?? null), array('id' => 'form_description', 'class' => 'form-control', 'placeholder' => 'Formularbeschreibung', 'required')) !!}
                            </div>
